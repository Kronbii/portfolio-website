...
export function UniversalCard({
  ...
  return (
    <motion.div
      ...
      className={`group relative overflow-hidden border bg-transparent flex-shrink-0 transition-all duration-75 flex flex-col ${isCentered
    ...
    >
      ...
      <div className="relative flex-shrink-0" style={{
        ...
        {hasImage ? (
          <div className="relative w-full h-full overflow-hidden" style={{ border: 'none', outline: 'none', borderRadius: 0 }}>
            <Image
              src={image}
              alt={imageAlt}
              fill
