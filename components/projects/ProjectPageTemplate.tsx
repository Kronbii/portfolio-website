    ...
    <div className="min-h-screen bg-light-bg dark:bg-dark-bg">
      ...
      <div className="sticky top-0 z-40 backdrop-blur-xl bg-light-bg/80 dark:bg-dark-bg/80 border-b border-light-border/50 dark:border-white/10">
        <div className="w-full px-4 sm:px-6 lg:px-8 py-4">
          <Link
            href="/#projects"
            className="inline-flex items-center space-x-2 text-[#252525] hover:text-primary-600 dark:hover:text-primary-400 transition-colors"
          >
            <FiArrowLeft size={20} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {project.features && project.features.length > 0 && (
              ...
              >
                <h2 className={`${getSectionHeaderStyle().className} mb-4`} style={getSectionHeaderStyle().style}>
                  Key Features
                </h2>
                <ul className="space-y-3">
                  {project.features.map((feature, idx) => (
                    <li key={idx} className="flex items-start space-x-3 text-[#252525]">
          ...
          <div className="space-y-6">
            ...
            >
              <h3 className="text-xl font-bold mb-4 text-[#252525]">
                Project Details
              </h3>
              <div className="space-y-4">
                <div>
                  <p className="text-sm text-[#252525] mb-1">Links</p>
